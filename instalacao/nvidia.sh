...
# ==============================================================================
# Hyprland configurando NVIDIA para o Hyprland
# ==============================================================================
# Esse script automatiza a instalação dos drivers da nvidia para uso do 
# Hyprland no Arch Linux, seguindo as diretrizes oficiais da Hyprland wiki.
#
#
# Copiado de  https://github.com/basecamp/omarchy/blob/master/install/config/nvidia.sh
# Criador original: https://github.com/Kn0ax
#
# ==============================================================================
